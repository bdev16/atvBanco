...
void main() {
  Banco banco = Banco.Usuario(
      agencia: 380,
      conta: 1234354,
      cliente: "Robson Teixeira da Silva",
      diaNascimento: 1,
      mesNascimento: 4,
      anoNascimento: 1987);
  UI(banco);
...
class Banco {
  ...
  Banco.Usuario(
      ...
      required int diaNascimento,
      required int mesNascimento,
    ...
    _dataNascimento = "$diaNascimento/$mesNascimento/$anoNascimento";
  }

  // Métodos getter e setter omitidos para brevidade
